...
def main():
    clr_accs_xt0, clr_accs_xt50, clr_accs_xt100 = [], [], []
    clf_accs_xt0, clf_accs_xt50, clf_accs_xt100 = [], [], []
    ...
    ax.axvline(x[0], c="r", label="_")
    ax.text(0.25, 0.7, "Nominal", rotation=90, c="r", fontsize=13)
    ...
    plt.savefig("segcube_line_chart.pdf")
    plt.close()
