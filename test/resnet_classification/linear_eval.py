...
def evaluate(wandb_artifact=None):
    ...
    train_feats_simclr = prepare_data_features(simclr_model, train_dataset, filename=f'{identifier}_train_resnet.pt')
    test_feats_simclr = prepare_data_features(simclr_model, test_dataset, filename=f'{identifier}_test_resnet.pt')
